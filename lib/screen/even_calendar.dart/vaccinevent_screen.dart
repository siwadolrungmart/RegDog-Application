...
class AddVaccineEventPage extends StatefulWidget {
  const AddVaccineEventPage({super.key});

  @override
  State<AddVaccineEventPage> createState() => _AddWalkEventPageState();
}

class _AddWalkEventPageState extends State<AddVaccineEventPage> {
