...
class AddSymptomEventPage extends StatefulWidget {
  const AddSymptomEventPage({super.key});

  @override
  State<AddSymptomEventPage> createState() => _AddWalkEventPageState();
}

class _AddWalkEventPageState extends State<AddSymptomEventPage> {
